...
stage_ids:
  ...
  - multiplication_facts_foundations
  - multiplication_facts_through_5
  - multiplication_facts_through_10
playlist_ids:
  - readiness_and_bonds_within_5
  - addition_and_subtraction_facts_to_10
  - addition_and_subtraction_facts_to_20
  ...
  - multiplication_facts_through_10
entry_points:
  age_5: readiness_and_bonds_within_5
  age_7: addition_and_subtraction_facts_to_10
...
- counting in ones instead of recalling the fact
...
- answer mixed addition and subtraction facts through 20 with only occasional hesitation
...
- fewer stalls in written sums
- more ability to explain why a fact is true instead of only guessing or reciting
...
The route is ordered deliberately. Each playlist exists because it prepares the next one.

### 1. [Readiness And Bonds Within 5](./playlists/readiness-and-bonds-within-5.md)

Use this when a learner is still shaky on tiny number relationships.

What changes here:

- small groups stop feeling like separate counting problems every time
- pairs that make 5 become familiar instead of newly computed
- tiny addition and subtraction facts start feeling connected

### 2. [Addition And Subtraction Facts To 10](./playlists/addition-and-subtraction-facts-to-10.md)

This is the normal start for a learner who can already count and record simple answers.
...
This stage extends fluency through 20 and introduces missing-number thinking.
...
This is the right multiplication entry point for most learners in the pathway.
...
This broadens the route without making it too large too quickly.

What changes here:

- `3` and `4` facts stop being isolated hard spots
- shuffled multiplication prompts through `5 x 5` become manageable
- the learner becomes less dependent on reciting a whole table before answering one fact

### 6. [Multiplication Facts Through 10](./playlists/multiplication-facts-through-10.md)

This completes the fact-fluency route.
...
Age is only an entry guide. It does not replace judgment.

### Five-Year-Old

Start at [Readiness And Bonds Within 5](./playlists/readiness-and-bonds-within-5.md).

Use this only if the child can already attend to a short calm practice block. Stop after the readiness playlist and reassess before moving on.

### Seven-Year-Old

The default start is [Addition And Subtraction Facts To 10](./playlists/addition-and-subtraction-facts-to-10.md).

Drop back to readiness only if number bonds within 5 are still clearly slow or shaky.

### Ten-Year-Old

Begin with a quick baseline check from [Multiplication Facts Foundations](./playlists/multiplication-facts-foundations.md).
...
Do not move on just because the learner can complete one grouped worksheet. The route is trying to build recall that holds under light pressure and mixed review.

Do not repeat the whole pathway when only a small cluster of facts is weak. Repeat the weak facts often, but keep the overall route moving when the larger stage is secure enough.

## Exit Conditions

This pathway is secure when the learner can:

- answer most mixed addition and subtraction facts through 20 accurately
...
This document is the human route description for the pathway.
