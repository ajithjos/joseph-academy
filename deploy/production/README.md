...
If you want a standalone developer-docs site on the host, build it separately with:
...
The library content itself is served through the control-plane API and rendered inside Flutter.
