      ...
      builder: (context, _) {
        return MaterialApp(
          ...
          builder: (context, child) =>
              _AppBackdrop(child: child ?? const SizedBox.shrink()),
    ...
    final scheme =
        ColorScheme.fromSeed(
          ...
          primaryContainer: isDark
              ? const Color(0xFF47330C)
              : const Color(0xFFFFEDC1),
          onPrimaryContainer: isDark
              ? _BrandPalette.goldSoft
              : _BrandPalette.navy,
          secondary: isDark ? _BrandPalette.slateText : _BrandPalette.navy,
          onSecondary: isDark
              ? _BrandPalette.obsidian
              : _BrandPalette.warmWhite,
          secondaryContainer: isDark
              ? _BrandPalette.slateHigh
              : _BrandPalette.navySoft,
          onSecondaryContainer: isDark
              ? _BrandPalette.slateText
              : _BrandPalette.navy,
          ...
          onSurfaceVariant: isDark
              ? _BrandPalette.slateMuted
              : const Color(0xFF6F655A),
    ...
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        ...
        selectedColor: isDark
            ? _BrandPalette.goldBright.withValues(alpha: 0.22)
            : _BrandPalette.gold.withValues(alpha: 0.16),
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        indicatorColor: isDark
            ? Color.alphaBlend(
                _BrandPalette.goldBright.withValues(alpha: 0.16),
                _BrandPalette.slateHigh,
              )
            : Color.alphaBlend(
      ...
      listTileTheme: ListTileThemeData(
        ...
        selectedTileColor: isDark
            ? Color.alphaBlend(
                _BrandPalette.goldBright.withValues(alpha: 0.12),
                scheme.surfaceContainerLow,
              )
            : Color.alphaBlend(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        fillColor: Color.alphaBlend(
          scheme.surface.withValues(alpha: isDark ? 0.72 : 0.94),
          scheme.surfaceContainerLow,
        ),
      ...
      menuTheme: MenuThemeData(
        style: MenuStyle(
          ...
          side: WidgetStatePropertyAll(
            BorderSide(color: scheme.outlineVariant.withValues(alpha: 0.68)),
          ),
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: isDark
              ? const [Color(0xFF11100F), Color(0xFF1A1714), Color(0xFF121110)]
              : const [Color(0xFFFBF8F1), Color(0xFFF3EBDD), Color(0xFFF9F5EE)],
      ...
      child: Stack(
        children: [
          ...
          _BackdropOrb(
            ...
            colors: [
              (isDark ? _BrandPalette.slateMuted : _BrandPalette.stone)
          ...
          _BackdropOrb(
            ...
            colors: [
              (isDark ? _BrandPalette.goldDeep : _BrandPalette.goldSoft)
