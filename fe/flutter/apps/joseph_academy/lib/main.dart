...
void main() {
  runApp(const JosephAcademyApp());
}

class JosephAcademyApp extends StatelessWidget {
  const JosephAcademyApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const JosephAcademyHomePage(),
    );
  }
}

class JosephAcademyHomePage extends StatefulWidget {
  const JosephAcademyHomePage({super.key});

  @override
  State<JosephAcademyHomePage> createState() => _JosephAcademyHomePageState();
}

class _JosephAcademyHomePageState extends State<JosephAcademyHomePage> {
  final JosephAcademyApiClient _apiClient = JosephAcademyApiClient();
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Joseph Academy'),
